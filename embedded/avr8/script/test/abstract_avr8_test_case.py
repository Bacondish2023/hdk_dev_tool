...
class AbstractAvr8TestCase(unittest.TestCase):

    def setUp(self, exmaple_project_name):
        self._process = None

        self._path_at_start = os.getcwd()
        self._path_exmaple_project = 'embedded' + os.sep + 'avr8' + os.sep + 'script' + os.sep + 'test' + os.sep + exmaple_project_name
        self._path_code_dir = 'embedded' + os.sep + 'avr8' + os.sep + 'script' + os.sep + 'code'
        ...
        self._list_script_filename = (
            ...
            'do_test.sh',
            'CMakePresets.json',
            'toolchain_avr8_real.cmake',
            'toolchain_avr8_simulation.cmake',
        )
...
def isToolchainAvailable():
    '''
    @brief Returns AVR8 toolchain is available or not
    '''

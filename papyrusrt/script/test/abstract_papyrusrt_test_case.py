...
class AbstractPapyrusRtTestCase(unittest.TestCase):

    def setUp(self, exmaple_project_name):
        self._process = None

        self._path_at_start = os.getcwd()
        self._path_exmaple_project = 'papyrusrt' + os.sep + 'script' + os.sep + 'test' + os.sep + exmaple_project_name
        self._path_code_dir = 'papyrusrt' + os.sep + 'script' + os.sep + 'code'
        ...
        self._command_start_papyrusrt = self._get_command('start_papyrusrt')

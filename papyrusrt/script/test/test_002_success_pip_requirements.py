...
class Test_002_SuccessPipRequirements(abstract_papyrusrt_test_case.AbstractPapyrusRtTestCase):

    def setUp(self):
        super().setUp('002_success_pip_requirements')


    def test_typical(self):
        # Test Settings
        self._enable_pip_requirements()

...
class Test_002_SuccessPipRequirements(unittest.TestCase):

    def setUp(self):
        self.__path_at_start = os.getcwd()
        self.__path_exmaple_project = 'papyrusrt' + os.sep + 'script' + os.sep + 'test' + os.sep + '002_success_pip_requirements'

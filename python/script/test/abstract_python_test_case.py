...
class AbstractPythonTestCase(unittest.TestCase):

    def setUp(self, exmaple_project_name):
        self._process = None

        self._path_at_start = os.getcwd()
        self._path_exmaple_project = 'python' + os.sep + 'script' + os.sep + 'test' + os.sep + exmaple_project_name
        self._path_code_dir = 'python' + os.sep + 'script' + os.sep + 'code'

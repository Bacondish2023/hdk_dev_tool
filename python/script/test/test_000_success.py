...
class Test_000_Success(unittest.TestCase):

    def setUp(self):
        self.__path_at_start = os.getcwd()
        self.__path_exmaple_project = 'python' + os.sep + 'script' + os.sep + 'test' + os.sep + '000_success'
        self.__path_code_dir = 'python' + os.sep + 'script' + os.sep + 'code'
